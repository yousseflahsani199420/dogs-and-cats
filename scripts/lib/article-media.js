...
function resolveArticleVisual(article, heading = "", index = 0, prefix = "") {
...
function resolveArticleFeaturedImage(article, prefix = "") {
...
function buildInlineArticleFigure(article, heading = "", index = 0, prefix = "") {
...
module.exports = {
  ...
  resolveArticleFeaturedImage,
  buildInlineArticleFigure,
};
